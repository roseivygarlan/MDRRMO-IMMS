        ...
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            <div class="text-center mb-5">
                @if (session()->has('success'))
                    <div id="alert-border-3" class="flex items-center p-4 mt-4 text-green-800 border-t-4 border-green-300 bg-green-50" role="alert">
                        ...
                        <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex items-center justify-center h-8 w-8 alert-del"  data-dismiss-target="#alert-border-3" aria-label="Close">
